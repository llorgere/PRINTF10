...
static char	*ft_add_plus0(char *str, t_flag flag, int len)
{
...
static char	*ft_add_space0(char *str, t_flag flag, int len)
{
	if(flag.width > len && str[0] != '-')
	{
		str[0] = ' ';
...
static char	*ft_add_dies_o0(char *str, t_flag flag, int len)
{
	if(flag.width > len)
	{
		str[0] = '0';
...
static char	*ft_add_dies_x0(char *str, t_flag flag, int len)
{
	char	*tab;
	int		i;
...
static char	*ft_add_dies0(char *str, t_flag flag, int len)
{
...
static char	*ft_addwf0(char *str, t_flag flag, int len)
{
	if (flag.dies == 1)
